...
@:forward(ACTIVE_ATTRIBUTES, ACTIVE_TEXTURE, ACTIVE_UNIFORMS, ALIASED_LINE_WIDTH_RANGE, ALIASED_POINT_SIZE_RANGE, ALPHA, ALPHA_BITS, ALWAYS, ARRAY_BUFFER,
	...
	bindFramebuffer, bindRenderbuffer, bindTexture, blendColor, blendEquation, blendEquationSeparate, blendFunc, blendFuncSeparate, blendBarrier, bufferData, bufferSubData,
	...
	getExtension, getFramebufferAttachmentParameteriv, getInteger, getIntegerv, getProgramInfoLog, getProgrami, getProgramiv, getRenderbufferParameteri,
	getRenderbufferParameteriv, getShaderi, getShaderInfoLog, getShaderiv, getShaderPrecisionFormat, getShaderSource, getString, getSupportedExtensions, getTexParameterf,
