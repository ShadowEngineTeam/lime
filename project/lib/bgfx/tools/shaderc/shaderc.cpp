...
// when shaderc is linked into the same binary as the bgfx runtime (lime),
// fatal/trace are provided by bgfx.cpp
#ifndef SHADERC_LINKED_WITH_BGFX
...
// provided by bgfx.cpp when linked with the bgfx runtime
#ifndef SHADERC_LINKED_WITH_BGFX
