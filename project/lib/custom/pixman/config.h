...
#if (defined(HX_WINDOWS) && !defined(HXCPP_ARM64)) || (defined(HX_MACOS) && !defined(HXCPP_ARM64)) || (defined(HX_LINUX) && (!defined(HXCPP_ARM64) && !defined(HXCPP_ARMV7)))
#define USE_SSE2 1
#else
/* #undef USE_SSE2 */
#endif
...
#if !defined(HXCPP_M64) && (defined(HX_WINDOWS) && !defined(HXCPP_ARM64)) || (defined(HX_MACOS) && !defined(HXCPP_ARM64)) || (defined(HX_LINUX) && (!defined(HXCPP_ARM64) && !defined(HXCPP_ARMV7)))
