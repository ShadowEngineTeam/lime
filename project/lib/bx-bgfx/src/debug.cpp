...
// lime patch: parameter types must match the Windows SDK exactly (DWORD is
// unsigned long, not uint32_t) or newer SDK headers included later in the
// same (amalgamated) TU fail with C2733 "cannot overload extern C function"
struct _OVERLAPPED;
