...
namespace lime
{
	...
	struct RGBA
	{
	  public:
		...
		inline RGBA(unsigned char r, unsigned char g, unsigned char b, unsigned char a) { Set(r, g, b, a); }
		...
		inline bool operator==(RGBA &rgba) { return (a == rgba.a && r == rgba.r && g == rgba.g && b == rgba.b); }
