...
class AndroidPlatform extends PlatformTarget
{
	...
	public override function update():Void
	{
		...
		context.ANDROID_GRADLE_VERSION = project.config.getString("android.gradle-version", "9.3.1");
		context.ANDROID_GRADLE_PLUGIN = project.config.getString("android.gradle-plugin", "9.1.0");
